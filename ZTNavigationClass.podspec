#
#  Be sure to run `pod spec lint ZTNavigationClass.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/NimoZone/ZTNavigationClass"
  ...
  s.source_files = "Classes/*.{h,m}"  #代码路径
